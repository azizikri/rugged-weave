...
- `apps/web/.env`
  ...
  - `VITE_GOOGLE_CLIENT_ID` – Enables the Google button when set alongside server credentials.
  - `VITE_APPLE_CLIENT_ID` – Enables the Apple button when paired with the server-side secret configuration.
