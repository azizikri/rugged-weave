...
type TestController = {};
type ExecutionContext<Props = unknown> = {
...
> = {};
type DurableObjectState<Props = unknown> = {
  waitUntil(promise: Promise<any>): void;
  readonly props: Props;
  readonly id: DurableObjectId;
...
type Ai_Cf_Meta_Llama_4_Async_Batch = {
  requests: (
    | Ai_Cf_Meta_Llama_4_Prompt_Inner
    | Ai_Cf_Meta_Llama_4_Messages_Inner
  )[];
};
type Ai_Cf_Meta_Llama_4_Prompt_Inner = {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
type Ai_Cf_Meta_Llama_4_Messages_Inner = {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
...
type GPT_OSS_20B_Responses_Async = {
  requests: {
    /**
     * Responses API Input messages. Refer to OpenAI Responses API docs to learn more about supported content types
     */
...
declare module "cloudflare:node" {
  ...
  export function httpServerHandler(
    server: NodeStyleServer | { port: number } | number
  ): ExportedHandler;
}
